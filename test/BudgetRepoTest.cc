...
public:
    void SetupDefaultBudge2() {
        ...
        Budget budget;
        budget.month = year_month_day{2019_y / 1 / 1};
        budget.amount = 31;
        list_budget.push_back(budget);

        budget.month = year_month_day{2019_y / 2 / 1};
        budget.amount = 280;
        list_budget.push_back(budget);
        budget.month = year_month_day{2019_y / 3 / 1};
        budget.amount = 310;
        list_budget.push_back(budget);
        budget.month = year_month_day{2019_y / 4 / 1};
        budget.amount = 30;
        list_budget.push_back(budget);
